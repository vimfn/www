...
const workPage = () => {
	return (
		<section>
			<div className="pb-10">
				<h1 className="text-2xl font-bold pb-8">Work</h1>I love building side
				projects that solve either my own or someone else&apos;s problems. Here
				is an extensive list (except for a few which are private or work in
				progress) of all the stuff I have worked on over the years.
				<br />
				<br />
				<p>
