...
export default function Home({
  ...
  return (
    <div className="space-y-10">
      ...
      <b>❄️️ Looking for my projects.. </b><a className="hover-underline-animation" href="https://github.com/its-ag/" target="_blank" rel="noreferrer"> Well, <b className="text-gold"> Github</b> is the place of all of my codes. </a> 
      </p>
