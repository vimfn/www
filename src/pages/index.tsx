    ...
    <div className="space-y-10">
      <div className="border-b-[1px] pb-5 border-muted">
        ...
        <h2 className="mt-3 md:text-lg text-subtle">
          ...
          <b> I'm a 17 y/o self-taught developer,  <a className="text-gold hover-underline-animation" href="https://hi.arunava.tech" target="_blank" rel="noopener noreferrer"> reach out to me 📧. </a>  </b> 
        </h2>
      </div>
